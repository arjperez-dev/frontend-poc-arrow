...
abstract class AppLocalizations {
  ...
  /// No description provided for @challengeTimeAttackDescription.
  ///
  /// In en, this message translates to:
  /// **'Beat the level before the clock runs out.'**
  String get challengeTimeAttackDescription;

  /// No description provided for @challengeMoveLimit.
  ///
  /// In en, this message translates to:
  /// **'Move Limit'**
  String get challengeMoveLimit;

  /// No description provided for @challengeMoveLimitDescription.
  ///
  /// In en, this message translates to:
  /// **'Clear every arrow within a fixed move budget.'**
  String get challengeMoveLimitDescription;

  /// No description provided for @challengePerfectRun.
  ///
  /// In en, this message translates to:
  /// **'Perfect Run'**
  String get challengePerfectRun;

  /// No description provided for @challengePerfectRunDescription.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @flawless.
  ///
  /// In en, this message translates to:
  /// **'Flawless'**
  String get flawless;

  /// No description provided for @challengeBest.
  ///
  /// In en, this message translates to:
  /// **'Challenge best'**
  String get challengeBest;
  ...
  /// No description provided for @challengeFailedTimeUp.
  ///
  /// In en, this message translates to:
  /// **'Time is up!'**
  String get challengeFailedTimeUp;

  /// No description provided for @challengeFailedOutOfMoves.
  ///
  /// In en, this message translates to:
  /// **'Out of moves!'**
  String get challengeFailedOutOfMoves;

  /// No description provided for @challengeFailedMistake.
  ///
  /// In en, this message translates to:
  /// **'A collision ended your perfect run.'**
